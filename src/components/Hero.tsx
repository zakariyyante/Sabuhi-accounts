...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative py-4 md:py-6 bg-gradient-to-br from-[#1a1625] via-[#2d1b4e] to-[#1f1f2e] border-b border-purple-400/20 overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden opacity-20">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#7C3AED]/30 rounded-full blur-3xl animate-pulse-slow"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-[#F59E0B]/30 rounded-full blur-3xl animate-pulse-slow" style={{animationDelay: '1s'}}></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-center mb-3 text-xs">
          <div className="flex items-center gap-2 text-gray-400">
            ...
            <span className="font-semibold">REFRESHED {currentDate}</span>
          </div>
        </div>
        ...
        <div className="text-center mb-4">
          ...
          <div className={`w-full overflow-x-auto ${!siteConfig.hero.subtext ? 'mt-0' : ''}`}>
            <div className="flex items-center justify-center md:justify-center gap-2 md:gap-3 min-w-max px-4">
              {/* UK Licensed */}
              <div className="bg-gradient-to-r from-[#F59E0B] to-[#FBBF24] text-gray-900 font-bold text-xs md:text-sm px-3 md:px-4 py-2 rounded-full shadow-lg flex items-center gap-2 whitespace-nowrap">
